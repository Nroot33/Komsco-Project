...
<form name="form1" method="post" action="test.jsp" enctype="multipart/form-data">
	<input type="text" name="filename"> <input
		type="file" name="myimg"> <input
		type="submit" name="Upload image" value="Upload image"> <br> <br>
</form>
